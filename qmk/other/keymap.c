...
[BASE] = LAYOUT_all(
  ...
  KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(FN),  \
  MO(FN),  KC_LGUI, KC_LALT,                   KC_SPC,                                      KC_RALT, TD(ARMO),MO(UTIL),KC_RCTL),

[FN] = LAYOUT_all(
  KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_TILD,\
  _______, RGB_MOD, RGB_HUI, RGB_TOG, _______, _______, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   _______, _______, 		\
  KC_CAPS, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,KC_PENT, 			\
...
[UTIL] = LAYOUT_all(
  ...
  _______, PSWD   , FFOX,    CLIN,    SMUG,    _______, _______, _______, _______, _______, _______, _______, _______, _______, 		\
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
	...
	case SMUG:
      if (record->event.pressed) {
        SEND_STRING("I really feel terrible, Whenever I look at that smug face() I really feel terrible");
      }
      return false;
      break;
  }
