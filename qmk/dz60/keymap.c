...
[BASE] = LAYOUT_all(
  ...
  KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______, KC_RSFT, MO(FN),	\
  MO(FN),  KC_LGUI, KC_LALT, KC_NO,            KC_SPC,                    KC_NO,   KC_NO,   TD(ARMO),KC_NO,   MO(UTIL),KC_RCTL),
...
[FN] = LAYOUT_all(
  ...
  _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, KC_PPLS, KC_PMNS, KC_END,  KC_PGDN, KC_DOWN, _______, _______, _______,\
