 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Win  | Alt  | Ctrl |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {KC_ESC,   KC_LGUI, KC_LALT, TG(_NUMPAD),LOWER,KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
/* Colemak
 * ,-----------------------------------------------------------------------------------.
...
[_LOWER] = {
  ...
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END },
...
[_NUMPAD] = {
  ...
  {_______, KC_LEFT, KC_DOWN, KC_RIGHT,_______, _______, _______, _______, KC_P4,   KC_P5,   KC_P6,   KC_PAST},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_PMNS, KC_PPLS}
}
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
	...
	case WHITE:
      if (record->event.pressed) {
		  rgblight_setrgb(255, 150, 85);
	  }
	  return false;
      break;
	case PURPLE:
      if (record->event.pressed) {
		  rgblight_setrgb(167, 0, 255);
	  }
	  return false;
      break;
	case GAYNUT:
