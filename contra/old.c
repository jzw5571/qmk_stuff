 ...
 */
[_ADJUST] = {
  {PASS,    GAYNUT,  LENNY,   RESER,   TEXT,    _______, _______, _______, _______, _______, _______, KC_DEL },
  {_______, _______, _______, _______, _______, _______, _______, QWERTY,  COLEMAK, DVORAK,  PLOVER,  _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______},
  {PURPLE,  WHITE,   RGB_MOD, RGB_TOG, _______, _______, _______, _______, RGB_HUD, RGB_VAD, RGB_VAI, RGB_HUI}
}
