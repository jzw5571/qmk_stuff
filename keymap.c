...
[BASE] = KEYMAP(
  ...
  KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, OSL(FN),			\
  OSL(FN),  KC_LGUI, KC_LALT, KC_NO,            KC_SPC,                    KC_NO,   KC_NO,   TD(AMTOG),KC_NO,  MO(UTIL),KC_RCTL),

[FN] = KEYMAP(
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  KC_GRV, \
...
[UTIL] = KEYMAP(
  ...
  KC_WAKE, PASS   , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 		\
...
[MKEY] = KEYMAP(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 		\
  _______, _______, _______, _______,          KC_BTN1,                   _______, _______, _______, _______, _______, _______),
...
qk_tap_dance_action_t tap_dance_actions[] = {
	[AMTOG] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_layers, dance_layers_reset)
};
